...
![Screenshot of Example Web Application](./images/selenium_webapp_screenshot.png)

## Configuring the Web Application

Email will be sent using the [Mailsac Outbound Message REST API](https://mailsac.com/docs/api#tag/Email-Messages-API/paths/~1outgoing-messages/post)
You will need to update `mailsacAPIKey` with your [API key](https://mailsac.com/api-keys). `mailsacFromAddress` is the
address that this example will use are the from address.
...
`npm start` from the command line. Use a web browser to view http://localhost:3000/index.html

1. Enter a username and email address.
   
   ![Webapp Form](./images/selenium_webapp_screenshot.png)

2. If everything went well you should see a confirmation.
   
   ![Webapp Confirmation](./images/selenium_webapp_confirmation.png)
...
4. Verify the message you sent has been received.
   ...
   ![Manual Verification of Received Email](./images/selenium_webapp_manual_verification.png)
